    ...
    return (
      <div>
        <h2 id="category-heading">
          <Translate contentKey="misingpieceApp.category.home.title">Categories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="misingpieceApp.category.home.createLabel">Create new Category</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="misingpieceApp.category.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="misingpieceApp.category.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
