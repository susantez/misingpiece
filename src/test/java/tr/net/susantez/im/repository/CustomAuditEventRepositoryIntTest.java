...
import tr.net.susantez.im.config.audit.AuditEventConverter;
import tr.net.susantez.im.domain.PersistentAuditEvent;
...
import static tr.net.susantez.im.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
