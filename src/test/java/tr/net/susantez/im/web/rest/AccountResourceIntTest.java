...
import tr.net.susantez.im.config.Constants;
import tr.net.susantez.im.MisingpieceApp;
import tr.net.susantez.im.domain.Authority;
import tr.net.susantez.im.domain.User;
import tr.net.susantez.im.repository.AuthorityRepository;
import tr.net.susantez.im.repository.UserRepository;
import tr.net.susantez.im.security.AuthoritiesConstants;
import tr.net.susantez.im.service.MailService;
import tr.net.susantez.im.service.dto.UserDTO;
import tr.net.susantez.im.service.dto.PasswordChangeDTO;
import tr.net.susantez.im.web.rest.errors.ExceptionTranslator;
import tr.net.susantez.im.web.rest.vm.KeyAndPasswordVM;
import tr.net.susantez.im.web.rest.vm.ManagedUserVM;
import tr.net.susantez.im.service.UserService;
