...
public class ProductResourceIntTest {
    ...
    private static final Float DEFAULT_TARGET_PRICE = 1F;
    private static final Float UPDATED_TARGET_PRICE = 2F;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getTargetPrice()).isEqualTo(DEFAULT_TARGET_PRICE);
    ...
    @Test
    @Transactional
    public void checkTargetPriceIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setTargetPrice(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].targetPrice").value(hasItem(DEFAULT_TARGET_PRICE.doubleValue())))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.targetPrice").value(DEFAULT_TARGET_PRICE.doubleValue()))
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .targetPrice(UPDATED_TARGET_PRICE)
        ...
        assertThat(testProduct.getTargetPrice()).isEqualTo(UPDATED_TARGET_PRICE);
